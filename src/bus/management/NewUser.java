...
public class NewUser extends javax.swing.JFrame {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        if(firstname.equals("") || lastname.equals("") || username.equals("") || password.equals("") || email.equals("") || phoneno.equals("+91") || phoneno.length()!=13 ){
        ...
        try {
           ...
           {
          String insertQuery = "insert into user_details values(null,'"+firstname+"','"+lastname+"','"+username+"','"+password+"','"+email+"','"+phoneno+"')";
